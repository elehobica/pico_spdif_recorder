...
void spdif_rec_wav::_req_finalize_file(inst_with_status_t& inst_w_sts, const bool report_flag, const float truncate_sec)
{
    file_cmd_data_t cmd_data;
...
void spdif_rec_wav::_set_truncate(const float sec)
{
    _truncate_sec = sec;
}
